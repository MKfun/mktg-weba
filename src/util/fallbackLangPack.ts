...
export default {
  ...
  TelegramFeatures: 'MKTG Features',
  ...
  Username: 'Username',
  UsernameHelp: 'You can choose a username on **MKTG**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  ...
  PhoneOther: 'Other',
  ContactJoined: 'Contact joined MKTG',
  ...
  lng_settings_sensitive_about: 'Display sensitive media in public channels on all your MKTG devices.',
  ...
  EnabledPasswordText: 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your MKTG account.',
  ...
  'Channel.Username.CreatePublicLinkHelp': 'People can share this link with others and find your channel using MKTG search.',
  ...
  'Group.Username.CreatePublicLinkHelp': 'People can share this link with others and find your group using MKTG search.',
  ...
  lng_update_telegram: 'Update MKTG',
  ...
  'Settings.TipsUsername': 'MKTGTips',
  ...
  'Video.Unsupported.Desktop': 'Unfortunately, this video can\'t be played on MKTG Web. Try opening it with our **desktop app** instead.',
  'Video.Unsupported.Mobile': 'Unfortunately, this video can\'t be played on MKTG Web. Try opening it with our **mobile app** instead.',
